...
const CreateProduct = () => {
    ...
    useEffect(() => {
        getCategories()
        .then(response => {
            setValues({...values, categories: response.data, formData: new FormData()})
        })
        .catch(err => {
            setValues({...values, error: 'Fail to load categories', formData: new FormData()})
        })
    }, [])
    ...
    const handleChange = (e) => {
        ...
        setValues({...values, [e.target.name]: value, error: false, success: false})
    ...
    const handleSubmit = (e) => {
        ...
        .catch(error => {
            ...
            setValues({...values, error: errMsg, loading: false, success: false, disabled: false});
        })
    }
