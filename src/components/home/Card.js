        ...
        <div className="col-md-3 col-sm-4 col-xs-12">
            <div className="card">
                ...
                <div className="card-body">
                    ...
                    <p>{product.quantity ? (<span className="bg-primary rounded" style={{padding: '0 5px 0 5px', color: 'white', fontWeight: 'bold'}}>In Stock</span>) : (<span className="bg-danger rounded" style={{padding: '0 5px 0 5px', color: 'white', fontWeight: 'bold'}} >Out of Stock</span>)}</p>
